...
import com.lacunasoftware.client.model.XmlSignatureTypes;
...
public class XmlSignatureOptions {
  ...
  private JsonNullable<String> elementToSignId = JsonNullable.<String>undefined();
  ...
  **/
  ...
  public XmlSignatureOptions elementToSignId(String elementToSignId) {
    this.elementToSignId = JsonNullable.<String>of(elementToSignId);
  ...
  **/
  ...
  public String getElementToSignId() {
        return elementToSignId.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_ELEMENT_TO_SIGN_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<String> getElementToSignId_JsonNullable() {
    return elementToSignId;
  }
  
  @JsonProperty(JSON_PROPERTY_ELEMENT_TO_SIGN_ID)
  public void setElementToSignId_JsonNullable(JsonNullable<String> elementToSignId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, xmlSignatureOptions.type) &&
        equalsNullable(this.elementToSignId, xmlSignatureOptions.elementToSignId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, hashCodeNullable(elementToSignId), signatureElementLocation);
  }
  ...
  public static class Builder {
    ...
    public XmlSignatureOptions.Builder elementToSignId(String elementToSignId) {
      this.instance.elementToSignId = JsonNullable.<String>of(elementToSignId);
      return this;
    }
    public XmlSignatureOptions.Builder elementToSignId(JsonNullable<String> elementToSignId) {
