 ...
 */
@JsonPropertyOrder({
  OpenXmlSignatureRequestModel.JSON_PROPERTY_ID_RESOLUTION_TABLE,
  OpenXmlSignatureRequestModel.JSON_PROPERTY_FILE,
  OpenXmlSignatureRequestModel.JSON_PROPERTY_VALIDATE,
  OpenXmlSignatureRequestModel.JSON_PROPERTY_AUDIT_PACKAGE,
  OpenXmlSignatureRequestModel.JSON_PROPERTY_DEFAULT_SIGNATURE_POLICY_ID,
  OpenXmlSignatureRequestModel.JSON_PROPERTY_ACCEPTABLE_EXPLICIT_POLICIES,
  OpenXmlSignatureRequestModel.JSON_PROPERTY_SECURITY_CONTEXT_ID,
  OpenXmlSignatureRequestModel.JSON_PROPERTY_IGNORE_REVOCATION_STATUS_UNKNOWN,
  OpenXmlSignatureRequestModel.JSON_PROPERTY_TRUST_UNCERTIFIED_SIGNING_TIME,
  OpenXmlSignatureRequestModel.JSON_PROPERTY_DATA_HASHES
})
...
public class OpenXmlSignatureRequestModel {
  ...
  public OpenXmlSignatureRequestModel() {
  }
  ...
  **/
  ...
  public OpenXmlSignatureRequestModel _file(FileModel _file) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.idResolutionTable, openXmlSignatureRequestModel.idResolutionTable) &&
        Objects.equals(this._file, openXmlSignatureRequestModel._file) &&
        ...
        equalsNullable(this.defaultSignaturePolicyId, openXmlSignatureRequestModel.defaultSignaturePolicyId) &&
        equalsNullable(this.acceptableExplicitPolicies, openXmlSignatureRequestModel.acceptableExplicitPolicies) &&
        equalsNullable(this.securityContextId, openXmlSignatureRequestModel.securityContextId) &&
        equalsNullable(this.ignoreRevocationStatusUnknown, openXmlSignatureRequestModel.ignoreRevocationStatusUnknown) &&
        Objects.equals(this.trustUncertifiedSigningTime, openXmlSignatureRequestModel.trustUncertifiedSigningTime) &&
        equalsNullable(this.dataHashes, openXmlSignatureRequestModel.dataHashes);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(idResolutionTable, _file, validate, auditPackage, hashCodeNullable(defaultSignaturePolicyId), hashCodeNullable(acceptableExplicitPolicies), hashCodeNullable(securityContextId), hashCodeNullable(ignoreRevocationStatusUnknown), trustUncertifiedSigningTime, hashCodeNullable(dataHashes));
  }
  ...
  public static class Builder {
    ...
    private OpenXmlSignatureRequestModel instance;

    public Builder() {
      this(new OpenXmlSignatureRequestModel());
    }

    protected Builder(OpenXmlSignatureRequestModel instance) {
      this.instance = instance;
    }

    public OpenXmlSignatureRequestModel.Builder idResolutionTable(XmlIdResolutionTableModel idResolutionTable) {
      this.instance.idResolutionTable = idResolutionTable;
      return this;
    }
    public OpenXmlSignatureRequestModel.Builder _file(FileModel _file) {
      this.instance._file = _file;
      return this;
    }
    public OpenXmlSignatureRequestModel.Builder validate(Boolean validate) {
      this.instance.validate = validate;
      return this;
    }
    public OpenXmlSignatureRequestModel.Builder auditPackage(AuditPackageOptions auditPackage) {
      this.instance.auditPackage = auditPackage;
      return this;
    }
    public OpenXmlSignatureRequestModel.Builder defaultSignaturePolicyId(UUID defaultSignaturePolicyId) {
      this.instance.defaultSignaturePolicyId = JsonNullable.<UUID>of(defaultSignaturePolicyId);
      return this;
    }
    public OpenXmlSignatureRequestModel.Builder defaultSignaturePolicyId(JsonNullable<UUID> defaultSignaturePolicyId) {
      this.instance.defaultSignaturePolicyId = defaultSignaturePolicyId;
      return this;
    }
    public OpenXmlSignatureRequestModel.Builder acceptableExplicitPolicies(List<UUID> acceptableExplicitPolicies) {
      this.instance.acceptableExplicitPolicies = JsonNullable.<List<UUID>>of(acceptableExplicitPolicies);
      return this;
    }
    public OpenXmlSignatureRequestModel.Builder acceptableExplicitPolicies(JsonNullable<List<UUID>> acceptableExplicitPolicies) {
      this.instance.acceptableExplicitPolicies = acceptableExplicitPolicies;
      return this;
    }
    public OpenXmlSignatureRequestModel.Builder securityContextId(UUID securityContextId) {
      this.instance.securityContextId = JsonNullable.<UUID>of(securityContextId);
      return this;
    }
    public OpenXmlSignatureRequestModel.Builder securityContextId(JsonNullable<UUID> securityContextId) {
      this.instance.securityContextId = securityContextId;
      return this;
    }
    public OpenXmlSignatureRequestModel.Builder ignoreRevocationStatusUnknown(Boolean ignoreRevocationStatusUnknown) {
      this.instance.ignoreRevocationStatusUnknown = JsonNullable.<Boolean>of(ignoreRevocationStatusUnknown);
      return this;
    }
    public OpenXmlSignatureRequestModel.Builder ignoreRevocationStatusUnknown(JsonNullable<Boolean> ignoreRevocationStatusUnknown) {
      this.instance.ignoreRevocationStatusUnknown = ignoreRevocationStatusUnknown;
      return this;
    }
    public OpenXmlSignatureRequestModel.Builder trustUncertifiedSigningTime(Boolean trustUncertifiedSigningTime) {
      this.instance.trustUncertifiedSigningTime = trustUncertifiedSigningTime;
      return this;
    }
    public OpenXmlSignatureRequestModel.Builder dataHashes(List<DigestAlgorithmAndValueModel> dataHashes) {
      this.instance.dataHashes = JsonNullable.<List<DigestAlgorithmAndValueModel>>of(dataHashes);
      return this;
    }
    public OpenXmlSignatureRequestModel.Builder dataHashes(JsonNullable<List<DigestAlgorithmAndValueModel>> dataHashes) {
    ...
    /**
    * returns a built OpenXmlSignatureRequestModel instance.
    *
    * The builder is not reusable.
    */
    public OpenXmlSignatureRequestModel build() {
      try {
  ...
  */
  public static OpenXmlSignatureRequestModel.Builder builder() {
    return new OpenXmlSignatureRequestModel.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public OpenXmlSignatureRequestModel.Builder toBuilder() {
    return new OpenXmlSignatureRequestModel.Builder()
