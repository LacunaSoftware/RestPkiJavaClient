 ...
 */
@JsonPropertyOrder({
  DocumentFileModel.JSON_PROPERTY_MIME_TYPE,
  DocumentFileModel.JSON_PROPERTY_CONTENT,
  DocumentFileModel.JSON_PROPERTY_BLOB_TOKEN,
  DocumentFileModel.JSON_PROPERTY_URL,
  DocumentFileModel.JSON_PROPERTY_NAME,
  DocumentFileModel.JSON_PROPERTY_LENGTH,
  DocumentFileModel.JSON_PROPERTY_CONTENT_TYPE,
  DocumentFileModel.JSON_PROPERTY_LOCATION
})
...
public class DocumentFileModel {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.mimeType, documentFileModel.mimeType) &&
        equalsNullable(this.content, documentFileModel.content) &&
        equalsNullable(this.blobToken, documentFileModel.blobToken) &&
        equalsNullable(this.url, documentFileModel.url) &&
        equalsNullable(this.name, documentFileModel.name) &&
        Objects.equals(this.length, documentFileModel.length) &&
        equalsNullable(this.contentType, documentFileModel.contentType) &&
        equalsNullable(this.location, documentFileModel.location);
  }
  ...
  public static class Builder {
    ...
    private DocumentFileModel instance;

    public Builder() {
      this(new DocumentFileModel());
    }

    protected Builder(DocumentFileModel instance) {
      this.instance = instance;
    }

    public DocumentFileModel.Builder mimeType(String mimeType) {
      this.instance.mimeType = JsonNullable.<String>of(mimeType);
      return this;
    }
    public DocumentFileModel.Builder mimeType(JsonNullable<String> mimeType) {
      this.instance.mimeType = mimeType;
      return this;
    }
    public DocumentFileModel.Builder content(byte[] content) {
      this.instance.content = JsonNullable.<byte[]>of(content);
      return this;
    }
    public DocumentFileModel.Builder content(JsonNullable<byte[]> content) {
      this.instance.content = content;
      return this;
    }
    public DocumentFileModel.Builder blobToken(String blobToken) {
      this.instance.blobToken = JsonNullable.<String>of(blobToken);
      return this;
    }
    public DocumentFileModel.Builder blobToken(JsonNullable<String> blobToken) {
      this.instance.blobToken = blobToken;
      return this;
    }
    public DocumentFileModel.Builder url(String url) {
      this.instance.url = JsonNullable.<String>of(url);
      return this;
    }
    public DocumentFileModel.Builder url(JsonNullable<String> url) {
      this.instance.url = url;
      return this;
    }
    public DocumentFileModel.Builder name(String name) {
      this.instance.name = JsonNullable.<String>of(name);
      return this;
    }
    public DocumentFileModel.Builder name(JsonNullable<String> name) {
      this.instance.name = name;
      return this;
    }
    public DocumentFileModel.Builder length(Long length) {
      this.instance.length = length;
      return this;
    }
    public DocumentFileModel.Builder contentType(String contentType) {
      this.instance.contentType = JsonNullable.<String>of(contentType);
      return this;
    }
    public DocumentFileModel.Builder contentType(JsonNullable<String> contentType) {
      this.instance.contentType = contentType;
      return this;
    }
    public DocumentFileModel.Builder location(String location) {
      this.instance.location = JsonNullable.<String>of(location);
      return this;
    }
    public DocumentFileModel.Builder location(JsonNullable<String> location) {
    ...
    /**
    * returns a built DocumentFileModel instance.
    *
    * The builder is not reusable.
    */
    public DocumentFileModel build() {
      try {
  ...
  */
  public static DocumentFileModel.Builder builder() {
    return new DocumentFileModel.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public DocumentFileModel.Builder toBuilder() {
    return new DocumentFileModel.Builder()
