 ...
 */
@JsonPropertyOrder({
  CmsSignatureOptions.JSON_PROPERTY_DETACHED,
  CmsSignatureOptions.JSON_PROPERTY_DATA_FILE,
  CmsSignatureOptions.JSON_PROPERTY_DATA_HASHES
})
...
public class CmsSignatureOptions {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.detached, cmsSignatureOptions.detached) &&
        ...
        equalsNullable(this.dataHashes, cmsSignatureOptions.dataHashes);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(detached, dataFile, hashCodeNullable(dataHashes));
  }
  ...
  public static class Builder {
    ...
    private CmsSignatureOptions instance;

    public Builder() {
      this(new CmsSignatureOptions());
    }

    protected Builder(CmsSignatureOptions instance) {
      this.instance = instance;
    }

    public CmsSignatureOptions.Builder detached(Boolean detached) {
      this.instance.detached = detached;
      return this;
    }
    public CmsSignatureOptions.Builder dataFile(FileReferenceModel dataFile) {
      this.instance.dataFile = dataFile;
      return this;
    }
    public CmsSignatureOptions.Builder dataHashes(List<DigestAlgorithmAndValueModel> dataHashes) {
      this.instance.dataHashes = JsonNullable.<List<DigestAlgorithmAndValueModel>>of(dataHashes);
      return this;
    }
    public CmsSignatureOptions.Builder dataHashes(JsonNullable<List<DigestAlgorithmAndValueModel>> dataHashes) {
    ...
    /**
    * returns a built CmsSignatureOptions instance.
    *
    * The builder is not reusable.
    */
    public CmsSignatureOptions build() {
      try {
  ...
  */
  public static CmsSignatureOptions.Builder builder() {
    return new CmsSignatureOptions.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public CmsSignatureOptions.Builder toBuilder() {
    return new CmsSignatureOptions.Builder()
      .detached(isDetached())
