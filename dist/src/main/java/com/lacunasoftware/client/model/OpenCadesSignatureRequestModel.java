 ...
 */
@JsonPropertyOrder({
  OpenCadesSignatureRequestModel.JSON_PROPERTY_EXTRACT_ENCAPSULATED_CONTENT,
  OpenCadesSignatureRequestModel.JSON_PROPERTY_FILE,
  OpenCadesSignatureRequestModel.JSON_PROPERTY_VALIDATE,
  OpenCadesSignatureRequestModel.JSON_PROPERTY_AUDIT_PACKAGE,
  OpenCadesSignatureRequestModel.JSON_PROPERTY_DEFAULT_SIGNATURE_POLICY_ID,
  OpenCadesSignatureRequestModel.JSON_PROPERTY_ACCEPTABLE_EXPLICIT_POLICIES,
  OpenCadesSignatureRequestModel.JSON_PROPERTY_SECURITY_CONTEXT_ID,
  OpenCadesSignatureRequestModel.JSON_PROPERTY_IGNORE_REVOCATION_STATUS_UNKNOWN,
  OpenCadesSignatureRequestModel.JSON_PROPERTY_TRUST_UNCERTIFIED_SIGNING_TIME,
  OpenCadesSignatureRequestModel.JSON_PROPERTY_DATA_HASHES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.6.0")
public class OpenCadesSignatureRequestModel {
  public static final String JSON_PROPERTY_EXTRACT_ENCAPSULATED_CONTENT = "extractEncapsulatedContent";
  private Boolean extractEncapsulatedContent;
  ...
  public OpenCadesSignatureRequestModel() {
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_EXTRACT_ENCAPSULATED_CONTENT)
  ...
  public OpenCadesSignatureRequestModel _file(FileModel _file) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.extractEncapsulatedContent, openCadesSignatureRequestModel.extractEncapsulatedContent) &&
        Objects.equals(this._file, openCadesSignatureRequestModel._file) &&
        ...
        equalsNullable(this.defaultSignaturePolicyId, openCadesSignatureRequestModel.defaultSignaturePolicyId) &&
        equalsNullable(this.acceptableExplicitPolicies, openCadesSignatureRequestModel.acceptableExplicitPolicies) &&
        equalsNullable(this.securityContextId, openCadesSignatureRequestModel.securityContextId) &&
        equalsNullable(this.ignoreRevocationStatusUnknown, openCadesSignatureRequestModel.ignoreRevocationStatusUnknown) &&
        Objects.equals(this.trustUncertifiedSigningTime, openCadesSignatureRequestModel.trustUncertifiedSigningTime) &&
        equalsNullable(this.dataHashes, openCadesSignatureRequestModel.dataHashes);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(extractEncapsulatedContent, _file, validate, auditPackage, hashCodeNullable(defaultSignaturePolicyId), hashCodeNullable(acceptableExplicitPolicies), hashCodeNullable(securityContextId), hashCodeNullable(ignoreRevocationStatusUnknown), trustUncertifiedSigningTime, hashCodeNullable(dataHashes));
  }
  ...
  public static class Builder {
    ...
    private OpenCadesSignatureRequestModel instance;

    public Builder() {
      this(new OpenCadesSignatureRequestModel());
    }

    protected Builder(OpenCadesSignatureRequestModel instance) {
      this.instance = instance;
    }

    public OpenCadesSignatureRequestModel.Builder extractEncapsulatedContent(Boolean extractEncapsulatedContent) {
      this.instance.extractEncapsulatedContent = extractEncapsulatedContent;
      return this;
    }
    public OpenCadesSignatureRequestModel.Builder _file(FileModel _file) {
      this.instance._file = _file;
      return this;
    }
    public OpenCadesSignatureRequestModel.Builder validate(Boolean validate) {
      this.instance.validate = validate;
      return this;
    }
    public OpenCadesSignatureRequestModel.Builder auditPackage(AuditPackageOptions auditPackage) {
      this.instance.auditPackage = auditPackage;
      return this;
    }
    public OpenCadesSignatureRequestModel.Builder defaultSignaturePolicyId(UUID defaultSignaturePolicyId) {
      this.instance.defaultSignaturePolicyId = JsonNullable.<UUID>of(defaultSignaturePolicyId);
      return this;
    }
    public OpenCadesSignatureRequestModel.Builder defaultSignaturePolicyId(JsonNullable<UUID> defaultSignaturePolicyId) {
      this.instance.defaultSignaturePolicyId = defaultSignaturePolicyId;
      return this;
    }
    public OpenCadesSignatureRequestModel.Builder acceptableExplicitPolicies(List<UUID> acceptableExplicitPolicies) {
      this.instance.acceptableExplicitPolicies = JsonNullable.<List<UUID>>of(acceptableExplicitPolicies);
      return this;
    }
    public OpenCadesSignatureRequestModel.Builder acceptableExplicitPolicies(JsonNullable<List<UUID>> acceptableExplicitPolicies) {
      this.instance.acceptableExplicitPolicies = acceptableExplicitPolicies;
      return this;
    }
    public OpenCadesSignatureRequestModel.Builder securityContextId(UUID securityContextId) {
      this.instance.securityContextId = JsonNullable.<UUID>of(securityContextId);
      return this;
    }
    public OpenCadesSignatureRequestModel.Builder securityContextId(JsonNullable<UUID> securityContextId) {
      this.instance.securityContextId = securityContextId;
      return this;
    }
    public OpenCadesSignatureRequestModel.Builder ignoreRevocationStatusUnknown(Boolean ignoreRevocationStatusUnknown) {
      this.instance.ignoreRevocationStatusUnknown = JsonNullable.<Boolean>of(ignoreRevocationStatusUnknown);
      return this;
    }
    public OpenCadesSignatureRequestModel.Builder ignoreRevocationStatusUnknown(JsonNullable<Boolean> ignoreRevocationStatusUnknown) {
      this.instance.ignoreRevocationStatusUnknown = ignoreRevocationStatusUnknown;
      return this;
    }
    public OpenCadesSignatureRequestModel.Builder trustUncertifiedSigningTime(Boolean trustUncertifiedSigningTime) {
      this.instance.trustUncertifiedSigningTime = trustUncertifiedSigningTime;
      return this;
    }
    public OpenCadesSignatureRequestModel.Builder dataHashes(List<DigestAlgorithmAndValueModel> dataHashes) {
      this.instance.dataHashes = JsonNullable.<List<DigestAlgorithmAndValueModel>>of(dataHashes);
      return this;
    }
    public OpenCadesSignatureRequestModel.Builder dataHashes(JsonNullable<List<DigestAlgorithmAndValueModel>> dataHashes) {
    ...
    /**
    * returns a built OpenCadesSignatureRequestModel instance.
    *
    * The builder is not reusable.
    */
    public OpenCadesSignatureRequestModel build() {
      try {
  ...
  */
  public static OpenCadesSignatureRequestModel.Builder builder() {
    return new OpenCadesSignatureRequestModel.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public OpenCadesSignatureRequestModel.Builder toBuilder() {
    return new OpenCadesSignatureRequestModel.Builder()
      .extractEncapsulatedContent(isExtractEncapsulatedContent())
      ._file(getFile())
      .validate(isValidate())
