 ...
 */
@JsonPropertyOrder({
  DocumentQueryResponse.JSON_PROPERTY_FOUND,
  DocumentQueryResponse.JSON_PROPERTY_DOCUMENT
})
...
public class DocumentQueryResponse {
  ...
  **/
  ...
  public static class Builder {
    ...
    private DocumentQueryResponse instance;

    public Builder() {
      this(new DocumentQueryResponse());
    }

    protected Builder(DocumentQueryResponse instance) {
      this.instance = instance;
    }

    public DocumentQueryResponse.Builder found(Boolean found) {
      this.instance.found = found;
      return this;
    }
    public DocumentQueryResponse.Builder document(DocumentModel document) {
    ...
    /**
    * returns a built DocumentQueryResponse instance.
    *
    * The builder is not reusable.
    */
    public DocumentQueryResponse build() {
      try {
  ...
  */
  public static DocumentQueryResponse.Builder builder() {
    return new DocumentQueryResponse.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public DocumentQueryResponse.Builder toBuilder() {
    return new DocumentQueryResponse.Builder()
      .found(isFound())
