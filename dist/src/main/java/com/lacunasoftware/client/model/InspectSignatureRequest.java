 ...
 */
@JsonPropertyOrder({
  InspectSignatureRequest.JSON_PROPERTY_FILE,
  InspectSignatureRequest.JSON_PROPERTY_VALIDATE,
  InspectSignatureRequest.JSON_PROPERTY_SECURITY_CONTEXT_ID,
  InspectSignatureRequest.JSON_PROPERTY_IGNORE_REVOCATION_STATUS_UNKNOWN,
  InspectSignatureRequest.JSON_PROPERTY_TRUST_UNCERTIFIED_SIGNING_TIME,
  InspectSignatureRequest.JSON_PROPERTY_DATA_FILE,
  InspectSignatureRequest.JSON_PROPERTY_DATA_HASHES,
  InspectSignatureRequest.JSON_PROPERTY_EXTRACT_ENCAPSULATED_CONTENT
})
...
public class InspectSignatureRequest {
  ...
  private FileReferenceModel dataFile;
  ...
  public InspectSignatureRequest() {
  }

  public InspectSignatureRequest _file(FileReferenceModel _file) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._file, inspectSignatureRequest._file) &&
        Objects.equals(this.validate, inspectSignatureRequest.validate) &&
        equalsNullable(this.securityContextId, inspectSignatureRequest.securityContextId) &&
        ...
        equalsNullable(this.dataHashes, inspectSignatureRequest.dataHashes) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(_file, validate, hashCodeNullable(securityContextId), ignoreRevocationStatusUnknown, trustUncertifiedSigningTime, dataFile, hashCodeNullable(dataHashes), extractEncapsulatedContent);
  }
  ...
  public static class Builder {
    ...
    private InspectSignatureRequest instance;

    public Builder() {
      this(new InspectSignatureRequest());
    }

    protected Builder(InspectSignatureRequest instance) {
      this.instance = instance;
    }

    public InspectSignatureRequest.Builder _file(FileReferenceModel _file) {
      this.instance._file = _file;
      return this;
    }
    public InspectSignatureRequest.Builder validate(Boolean validate) {
      this.instance.validate = validate;
      return this;
    }
    public InspectSignatureRequest.Builder securityContextId(UUID securityContextId) {
      this.instance.securityContextId = JsonNullable.<UUID>of(securityContextId);
      return this;
    }
    public InspectSignatureRequest.Builder securityContextId(JsonNullable<UUID> securityContextId) {
      this.instance.securityContextId = securityContextId;
      return this;
    }
    public InspectSignatureRequest.Builder ignoreRevocationStatusUnknown(Boolean ignoreRevocationStatusUnknown) {
      this.instance.ignoreRevocationStatusUnknown = ignoreRevocationStatusUnknown;
      return this;
    }
    public InspectSignatureRequest.Builder trustUncertifiedSigningTime(Boolean trustUncertifiedSigningTime) {
      this.instance.trustUncertifiedSigningTime = trustUncertifiedSigningTime;
      return this;
    }
    public InspectSignatureRequest.Builder dataFile(FileReferenceModel dataFile) {
      this.instance.dataFile = dataFile;
      return this;
    }
    public InspectSignatureRequest.Builder dataHashes(List<DigestAlgorithmAndValueModel> dataHashes) {
      this.instance.dataHashes = JsonNullable.<List<DigestAlgorithmAndValueModel>>of(dataHashes);
      return this;
    }
    public InspectSignatureRequest.Builder dataHashes(JsonNullable<List<DigestAlgorithmAndValueModel>> dataHashes) {
      this.instance.dataHashes = dataHashes;
      return this;
    }
    public InspectSignatureRequest.Builder extractEncapsulatedContent(Boolean extractEncapsulatedContent) {
    ...
    /**
    * returns a built InspectSignatureRequest instance.
    *
    * The builder is not reusable.
    */
    public InspectSignatureRequest build() {
      try {
  ...
  */
  public static InspectSignatureRequest.Builder builder() {
    return new InspectSignatureRequest.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public InspectSignatureRequest.Builder toBuilder() {
    return new InspectSignatureRequest.Builder()
      ._file(getFile())
      .validate(isValidate())
