 ...
 */
@JsonPropertyOrder({
  DigestAlgorithmAndValueModel.JSON_PROPERTY_ALGORITHM,
  DigestAlgorithmAndValueModel.JSON_PROPERTY_VALUE,
  DigestAlgorithmAndValueModel.JSON_PROPERTY_HEX_VALUE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.6.0")
public class DigestAlgorithmAndValueModel {
  public static final String JSON_PROPERTY_ALGORITHM = "algorithm";
  private DigestAlgorithms algorithm;
  ...
  public DigestAlgorithmAndValueModel() {
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.algorithm, digestAlgorithmAndValueModel.algorithm) &&
        equalsNullable(this.value, digestAlgorithmAndValueModel.value) &&
        equalsNullable(this.hexValue, digestAlgorithmAndValueModel.hexValue);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(algorithm, hashCodeNullable(value), hashCodeNullable(hexValue));
  }
  ...
  public static class Builder {
    ...
    private DigestAlgorithmAndValueModel instance;

    public Builder() {
      this(new DigestAlgorithmAndValueModel());
    }

    protected Builder(DigestAlgorithmAndValueModel instance) {
      this.instance = instance;
    }

    public DigestAlgorithmAndValueModel.Builder algorithm(DigestAlgorithms algorithm) {
      this.instance.algorithm = algorithm;
      return this;
    }
    public DigestAlgorithmAndValueModel.Builder value(byte[] value) {
      this.instance.value = JsonNullable.<byte[]>of(value);
      return this;
    }
    public DigestAlgorithmAndValueModel.Builder value(JsonNullable<byte[]> value) {
      this.instance.value = value;
      return this;
    }
    public DigestAlgorithmAndValueModel.Builder hexValue(String hexValue) {
      this.instance.hexValue = JsonNullable.<String>of(hexValue);
      return this;
    }
    public DigestAlgorithmAndValueModel.Builder hexValue(JsonNullable<String> hexValue) {
    ...
    /**
    * returns a built DigestAlgorithmAndValueModel instance.
    *
    * The builder is not reusable.
    */
    public DigestAlgorithmAndValueModel build() {
      try {
  ...
  */
  public static DigestAlgorithmAndValueModel.Builder builder() {
    return new DigestAlgorithmAndValueModel.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public DigestAlgorithmAndValueModel.Builder toBuilder() {
    return new DigestAlgorithmAndValueModel.Builder()
