 ...
 */
@JsonPropertyOrder({
  PadesSignaturePostRequestV1.JSON_PROPERTY_PDF_TO_SIGN,
  PadesSignaturePostRequestV1.JSON_PROPERTY_VISUAL_REPRESENTATION,
  PadesSignaturePostRequestV1.JSON_PROPERTY_PDF_MARKS,
  PadesSignaturePostRequestV1.JSON_PROPERTY_BYPASS_MARKS_IF_SIGNED,
  PadesSignaturePostRequestV1.JSON_PROPERTY_MEASUREMENT_UNITS,
  PadesSignaturePostRequestV1.JSON_PROPERTY_PAGE_OPTIMIZATION,
  PadesSignaturePostRequestV1.JSON_PROPERTY_CUSTOM_SIGNATURE_FIELD_NAME,
  PadesSignaturePostRequestV1.JSON_PROPERTY_CERTIFICATION_LEVEL,
  PadesSignaturePostRequestV1.JSON_PROPERTY_REASON,
  PadesSignaturePostRequestV1.JSON_PROPERTY_CERTIFICATE,
  PadesSignaturePostRequestV1.JSON_PROPERTY_SIGNATURE_POLICY_ID,
  PadesSignaturePostRequestV1.JSON_PROPERTY_SECURITY_CONTEXT_ID,
  PadesSignaturePostRequestV1.JSON_PROPERTY_CALLBACK_ARGUMENT,
  PadesSignaturePostRequestV1.JSON_PROPERTY_IGNORE_REVOCATION_STATUS_UNKNOWN
})
...
public class PadesSignaturePostRequestV1 {
  ...
  public PadesSignaturePostRequestV1() {
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Arrays.equals(this.pdfToSign, padesSignaturePostRequestV1.pdfToSign) &&
        ...
        equalsNullable(this.pdfMarks, padesSignaturePostRequestV1.pdfMarks) &&
        ...
        equalsNullable(this.customSignatureFieldName, padesSignaturePostRequestV1.customSignatureFieldName) &&
        Objects.equals(this.certificationLevel, padesSignaturePostRequestV1.certificationLevel) &&
        equalsNullable(this.reason, padesSignaturePostRequestV1.reason) &&
        equalsNullable(this.certificate, padesSignaturePostRequestV1.certificate) &&
        Objects.equals(this.signaturePolicyId, padesSignaturePostRequestV1.signaturePolicyId) &&
        equalsNullable(this.securityContextId, padesSignaturePostRequestV1.securityContextId) &&
        equalsNullable(this.callbackArgument, padesSignaturePostRequestV1.callbackArgument) &&
        equalsNullable(this.ignoreRevocationStatusUnknown, padesSignaturePostRequestV1.ignoreRevocationStatusUnknown);
  }
  ...
  public static class Builder {
    ...
    private PadesSignaturePostRequestV1 instance;

    public Builder() {
      this(new PadesSignaturePostRequestV1());
    }

    protected Builder(PadesSignaturePostRequestV1 instance) {
      this.instance = instance;
    }

    public PadesSignaturePostRequestV1.Builder pdfToSign(byte[] pdfToSign) {
      this.instance.pdfToSign = pdfToSign;
      return this;
    }
    public PadesSignaturePostRequestV1.Builder visualRepresentation(PadesVisualRepresentationModel visualRepresentation) {
      this.instance.visualRepresentation = visualRepresentation;
      return this;
    }
    public PadesSignaturePostRequestV1.Builder pdfMarks(List<PdfMarkModel> pdfMarks) {
      this.instance.pdfMarks = JsonNullable.<List<PdfMarkModel>>of(pdfMarks);
      return this;
    }
    public PadesSignaturePostRequestV1.Builder pdfMarks(JsonNullable<List<PdfMarkModel>> pdfMarks) {
      this.instance.pdfMarks = pdfMarks;
      return this;
    }
    public PadesSignaturePostRequestV1.Builder bypassMarksIfSigned(Boolean bypassMarksIfSigned) {
      this.instance.bypassMarksIfSigned = bypassMarksIfSigned;
      return this;
    }
    public PadesSignaturePostRequestV1.Builder measurementUnits(PadesMeasurementUnits measurementUnits) {
      this.instance.measurementUnits = measurementUnits;
      return this;
    }
    public PadesSignaturePostRequestV1.Builder pageOptimization(PadesPageOptimizationModel pageOptimization) {
      this.instance.pageOptimization = pageOptimization;
      return this;
    }
    public PadesSignaturePostRequestV1.Builder customSignatureFieldName(String customSignatureFieldName) {
      this.instance.customSignatureFieldName = JsonNullable.<String>of(customSignatureFieldName);
      return this;
    }
    public PadesSignaturePostRequestV1.Builder customSignatureFieldName(JsonNullable<String> customSignatureFieldName) {
      this.instance.customSignatureFieldName = customSignatureFieldName;
      return this;
    }
    public PadesSignaturePostRequestV1.Builder certificationLevel(PadesCertificationLevel certificationLevel) {
      this.instance.certificationLevel = certificationLevel;
      return this;
    }
    public PadesSignaturePostRequestV1.Builder reason(String reason) {
      this.instance.reason = JsonNullable.<String>of(reason);
      return this;
    }
    public PadesSignaturePostRequestV1.Builder reason(JsonNullable<String> reason) {
      this.instance.reason = reason;
      return this;
    }
    public PadesSignaturePostRequestV1.Builder certificate(byte[] certificate) {
      this.instance.certificate = JsonNullable.<byte[]>of(certificate);
      return this;
    }
    public PadesSignaturePostRequestV1.Builder certificate(JsonNullable<byte[]> certificate) {
      this.instance.certificate = certificate;
      return this;
    }
    public PadesSignaturePostRequestV1.Builder signaturePolicyId(UUID signaturePolicyId) {
      this.instance.signaturePolicyId = signaturePolicyId;
      return this;
    }
    public PadesSignaturePostRequestV1.Builder securityContextId(UUID securityContextId) {
      this.instance.securityContextId = JsonNullable.<UUID>of(securityContextId);
      return this;
    }
    public PadesSignaturePostRequestV1.Builder securityContextId(JsonNullable<UUID> securityContextId) {
      this.instance.securityContextId = securityContextId;
      return this;
    }
    public PadesSignaturePostRequestV1.Builder callbackArgument(String callbackArgument) {
      this.instance.callbackArgument = JsonNullable.<String>of(callbackArgument);
      return this;
    }
    public PadesSignaturePostRequestV1.Builder callbackArgument(JsonNullable<String> callbackArgument) {
      this.instance.callbackArgument = callbackArgument;
      return this;
    }
    public PadesSignaturePostRequestV1.Builder ignoreRevocationStatusUnknown(Boolean ignoreRevocationStatusUnknown) {
      this.instance.ignoreRevocationStatusUnknown = JsonNullable.<Boolean>of(ignoreRevocationStatusUnknown);
      return this;
    }
    public PadesSignaturePostRequestV1.Builder ignoreRevocationStatusUnknown(JsonNullable<Boolean> ignoreRevocationStatusUnknown) {
    ...
    /**
    * returns a built PadesSignaturePostRequestV1 instance.
    *
    * The builder is not reusable.
    */
    public PadesSignaturePostRequestV1 build() {
      try {
  ...
  */
  public static PadesSignaturePostRequestV1.Builder builder() {
    return new PadesSignaturePostRequestV1.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public PadesSignaturePostRequestV1.Builder toBuilder() {
    return new PadesSignaturePostRequestV1.Builder()
