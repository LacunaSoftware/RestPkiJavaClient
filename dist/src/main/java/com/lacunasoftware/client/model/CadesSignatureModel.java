 ...
 */
@JsonPropertyOrder({
  CadesSignatureModel.JSON_PROPERTY_ENCAPSULATED_CONTENT_TYPE,
  CadesSignatureModel.JSON_PROPERTY_HAS_ENCAPSULATED_CONTENT,
  CadesSignatureModel.JSON_PROPERTY_SIGNERS,
  CadesSignatureModel.JSON_PROPERTY_ENCAPSULATED_CONTENT,
  CadesSignatureModel.JSON_PROPERTY_AUDIT_PACKAGE,
  CadesSignatureModel.JSON_PROPERTY_B_STAMP
})
...
public class CadesSignatureModel {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.encapsulatedContentType, cadesSignatureModel.encapsulatedContentType) &&
        ...
        equalsNullable(this.signers, cadesSignatureModel.signers) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(encapsulatedContentType, hasEncapsulatedContent, hashCodeNullable(signers), encapsulatedContent, auditPackage, bStamp);
  }
  ...
  public static class Builder {
    ...
    private CadesSignatureModel instance;

    public Builder() {
      this(new CadesSignatureModel());
    }

    protected Builder(CadesSignatureModel instance) {
      this.instance = instance;
    }

    public CadesSignatureModel.Builder encapsulatedContentType(CmsContentTypes encapsulatedContentType) {
      this.instance.encapsulatedContentType = encapsulatedContentType;
      return this;
    }
    public CadesSignatureModel.Builder hasEncapsulatedContent(Boolean hasEncapsulatedContent) {
      this.instance.hasEncapsulatedContent = hasEncapsulatedContent;
      return this;
    }
    public CadesSignatureModel.Builder signers(List<CadesSignerModel> signers) {
      this.instance.signers = JsonNullable.<List<CadesSignerModel>>of(signers);
      return this;
    }
    public CadesSignatureModel.Builder signers(JsonNullable<List<CadesSignerModel>> signers) {
      this.instance.signers = signers;
      return this;
    }
    public CadesSignatureModel.Builder encapsulatedContent(FileModel encapsulatedContent) {
      this.instance.encapsulatedContent = encapsulatedContent;
      return this;
    }
    public CadesSignatureModel.Builder auditPackage(FileModel auditPackage) {
      this.instance.auditPackage = auditPackage;
      return this;
    }
    public CadesSignatureModel.Builder bStamp(SignatureBStampModel bStamp) {
    ...
    /**
    * returns a built CadesSignatureModel instance.
    *
    * The builder is not reusable.
    */
    public CadesSignatureModel build() {
      try {
  ...
  */
  public static CadesSignatureModel.Builder builder() {
    return new CadesSignatureModel.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public CadesSignatureModel.Builder toBuilder() {
    return new CadesSignatureModel.Builder()
