...
public class PrepareAuthenticationResponse {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.state, prepareAuthenticationResponse.state) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(state), toSignHash);
  }
  ...
  public static class Builder {
    ...
    public PrepareAuthenticationResponse.Builder state(JsonNullable<String> state) {
