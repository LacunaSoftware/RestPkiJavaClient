...
import com.lacunasoftware.client.model.DocumentStatus;
 ...
 */
@JsonPropertyOrder({
  SignatureSessionDocumentSummary.JSON_PROPERTY_STATUS,
  SignatureSessionDocumentSummary.JSON_PROPERTY_DATE_SIGNED,
  SignatureSessionDocumentSummary.JSON_PROPERTY_ID,
  SignatureSessionDocumentSummary.JSON_PROPERTY_KEY,
  SignatureSessionDocumentSummary.JSON_PROPERTY_FORMATTED_KEY,
  SignatureSessionDocumentSummary.JSON_PROPERTY_ORIGINAL_FILE,
  SignatureSessionDocumentSummary.JSON_PROPERTY_MARKED_FILE,
  SignatureSessionDocumentSummary.JSON_PROPERTY_SIGNED_FILE,
  SignatureSessionDocumentSummary.JSON_PROPERTY_SIGNATURE_TYPE,
  SignatureSessionDocumentSummary.JSON_PROPERTY_AVAILABLE_UNTIL
})
...
public class SignatureSessionDocumentSummary {
  ...
  private JsonNullable<OffsetDateTime> dateSigned = JsonNullable.<OffsetDateTime>undefined();
  ...
  public SignatureSessionDocumentSummary() {
  }
  ...
  **/
  ...
  public SignatureSessionDocumentSummary dateSigned(OffsetDateTime dateSigned) {
    this.dateSigned = JsonNullable.<OffsetDateTime>of(dateSigned);
  ...
  **/
  ...
  public OffsetDateTime getDateSigned() {
        return dateSigned.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_DATE_SIGNED)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<OffsetDateTime> getDateSigned_JsonNullable() {
    return dateSigned;
  }
  
  @JsonProperty(JSON_PROPERTY_DATE_SIGNED)
  public void setDateSigned_JsonNullable(JsonNullable<OffsetDateTime> dateSigned) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, signatureSessionDocumentSummary.status) &&
        equalsNullable(this.dateSigned, signatureSessionDocumentSummary.dateSigned) &&
        Objects.equals(this.id, signatureSessionDocumentSummary.id) &&
        equalsNullable(this.key, signatureSessionDocumentSummary.key) &&
        equalsNullable(this.formattedKey, signatureSessionDocumentSummary.formattedKey) &&
        ...
        equalsNullable(this.availableUntil, signatureSessionDocumentSummary.availableUntil);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(status, hashCodeNullable(dateSigned), id, hashCodeNullable(key), hashCodeNullable(formattedKey), originalFile, markedFile, signedFile, signatureType, hashCodeNullable(availableUntil));
  }
  ...
  public static class Builder {
    ...
    private SignatureSessionDocumentSummary instance;

    public Builder() {
      this(new SignatureSessionDocumentSummary());
    }

    protected Builder(SignatureSessionDocumentSummary instance) {
      this.instance = instance;
    }

    public SignatureSessionDocumentSummary.Builder status(DocumentStatus status) {
      this.instance.status = status;
      return this;
    }
    public SignatureSessionDocumentSummary.Builder dateSigned(OffsetDateTime dateSigned) {
      this.instance.dateSigned = JsonNullable.<OffsetDateTime>of(dateSigned);
      return this;
    }
    public SignatureSessionDocumentSummary.Builder dateSigned(JsonNullable<OffsetDateTime> dateSigned) {
      this.instance.dateSigned = dateSigned;
      return this;
    }
    public SignatureSessionDocumentSummary.Builder id(UUID id) {
      this.instance.id = id;
      return this;
    }
    public SignatureSessionDocumentSummary.Builder key(String key) {
      this.instance.key = JsonNullable.<String>of(key);
      return this;
    }
    public SignatureSessionDocumentSummary.Builder key(JsonNullable<String> key) {
      this.instance.key = key;
      return this;
    }
    public SignatureSessionDocumentSummary.Builder formattedKey(String formattedKey) {
      this.instance.formattedKey = JsonNullable.<String>of(formattedKey);
      return this;
    }
    public SignatureSessionDocumentSummary.Builder formattedKey(JsonNullable<String> formattedKey) {
      this.instance.formattedKey = formattedKey;
      return this;
    }
    public SignatureSessionDocumentSummary.Builder originalFile(DocumentFileModel originalFile) {
      this.instance.originalFile = originalFile;
      return this;
    }
    public SignatureSessionDocumentSummary.Builder markedFile(DocumentFileModel markedFile) {
      this.instance.markedFile = markedFile;
      return this;
    }
    public SignatureSessionDocumentSummary.Builder signedFile(DocumentFileModel signedFile) {
      this.instance.signedFile = signedFile;
      return this;
    }
    public SignatureSessionDocumentSummary.Builder signatureType(SignatureTypes signatureType) {
      this.instance.signatureType = signatureType;
      return this;
    }
    public SignatureSessionDocumentSummary.Builder availableUntil(OffsetDateTime availableUntil) {
      this.instance.availableUntil = JsonNullable.<OffsetDateTime>of(availableUntil);
      return this;
    }
    public SignatureSessionDocumentSummary.Builder availableUntil(JsonNullable<OffsetDateTime> availableUntil) {
    ...
    /**
    * returns a built SignatureSessionDocumentSummary instance.
    *
    * The builder is not reusable.
    */
    public SignatureSessionDocumentSummary build() {
      try {
  ...
  */
  public static SignatureSessionDocumentSummary.Builder builder() {
    return new SignatureSessionDocumentSummary.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public SignatureSessionDocumentSummary.Builder toBuilder() {
    return new SignatureSessionDocumentSummary.Builder()
      .status(getStatus())
