 ...
 */
@JsonPropertyOrder({
  CadesSignerModel.JSON_PROPERTY_MESSAGE_DIGEST,
  CadesSignerModel.JSON_PROPERTY_SIGNATURE,
  CadesSignerModel.JSON_PROPERTY_SIGNATURE_POLICY,
  CadesSignerModel.JSON_PROPERTY_CERTIFICATE,
  CadesSignerModel.JSON_PROPERTY_SIGNING_TIME,
  CadesSignerModel.JSON_PROPERTY_CERTIFIED_DATE_REFERENCE,
  CadesSignerModel.JSON_PROPERTY_TIMESTAMPS,
  CadesSignerModel.JSON_PROPERTY_VALIDATION_RESULTS,
  CadesSignerModel.JSON_PROPERTY_COMMITMENT_TYPE,
  CadesSignerModel.JSON_PROPERTY_B_STAMP
})
...
public class CadesSignerModel {
  ...
  **/
  ...
  public CadesSignerModel signingTime(OffsetDateTime signingTime) {
  ...
  **/
  ...
  public CadesSignerModel certifiedDateReference(OffsetDateTime certifiedDateReference) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.messageDigest, cadesSignerModel.messageDigest) &&
        ...
        equalsNullable(this.signingTime, cadesSignerModel.signingTime) &&
        equalsNullable(this.certifiedDateReference, cadesSignerModel.certifiedDateReference) &&
        equalsNullable(this.timestamps, cadesSignerModel.timestamps) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(messageDigest, signature, signaturePolicy, certificate, hashCodeNullable(signingTime), hashCodeNullable(certifiedDateReference), hashCodeNullable(timestamps), validationResults, commitmentType, bStamp);
  }
  ...
  public static class Builder {
    ...
    private CadesSignerModel instance;

    public Builder() {
      this(new CadesSignerModel());
    }

    protected Builder(CadesSignerModel instance) {
      this.instance = instance;
    }

    public CadesSignerModel.Builder messageDigest(DigestAlgorithmAndValueModel messageDigest) {
      this.instance.messageDigest = messageDigest;
      return this;
    }
    public CadesSignerModel.Builder signature(SignatureAlgorithmAndValueModel signature) {
      this.instance.signature = signature;
      return this;
    }
    public CadesSignerModel.Builder signaturePolicy(SignaturePolicyIdentifierModel signaturePolicy) {
      this.instance.signaturePolicy = signaturePolicy;
      return this;
    }
    public CadesSignerModel.Builder certificate(CertificateModel certificate) {
      this.instance.certificate = certificate;
      return this;
    }
    public CadesSignerModel.Builder signingTime(OffsetDateTime signingTime) {
      this.instance.signingTime = JsonNullable.<OffsetDateTime>of(signingTime);
      return this;
    }
    public CadesSignerModel.Builder signingTime(JsonNullable<OffsetDateTime> signingTime) {
      this.instance.signingTime = signingTime;
      return this;
    }
    public CadesSignerModel.Builder certifiedDateReference(OffsetDateTime certifiedDateReference) {
      this.instance.certifiedDateReference = JsonNullable.<OffsetDateTime>of(certifiedDateReference);
      return this;
    }
    public CadesSignerModel.Builder certifiedDateReference(JsonNullable<OffsetDateTime> certifiedDateReference) {
      this.instance.certifiedDateReference = certifiedDateReference;
      return this;
    }
    public CadesSignerModel.Builder timestamps(List<CadesTimestampModel> timestamps) {
      this.instance.timestamps = JsonNullable.<List<CadesTimestampModel>>of(timestamps);
      return this;
    }
    public CadesSignerModel.Builder timestamps(JsonNullable<List<CadesTimestampModel>> timestamps) {
      this.instance.timestamps = timestamps;
      return this;
    }
    public CadesSignerModel.Builder validationResults(ValidationResultsModel validationResults) {
      this.instance.validationResults = validationResults;
      return this;
    }
    public CadesSignerModel.Builder commitmentType(CommitmentTypeModel commitmentType) {
      this.instance.commitmentType = commitmentType;
      return this;
    }
    public CadesSignerModel.Builder bStamp(SignerBStampModel bStamp) {
    ...
    /**
    * returns a built CadesSignerModel instance.
    *
    * The builder is not reusable.
    */
    public CadesSignerModel build() {
      try {
  ...
  */
  public static CadesSignerModel.Builder builder() {
    return new CadesSignerModel.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public CadesSignerModel.Builder toBuilder() {
    return new CadesSignerModel.Builder()
