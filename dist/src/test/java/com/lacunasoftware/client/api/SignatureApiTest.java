...
public class SignatureApiTest {
     ...
     */
    @Test
    public void apiSignatureCompletionPostTest()  {
        CompleteSignatureRequestV2 completeSignatureRequestV2 = null;
        DocumentModel response = api.apiSignatureCompletionPost(completeSignatureRequestV2);
     ...
     */
    @Test
    public void apiSignaturePostTest()  {
        PrepareSignatureRequest prepareSignatureRequest = null;
        PrepareSignatureResponse response = api.apiSignaturePost(prepareSignatureRequest);
