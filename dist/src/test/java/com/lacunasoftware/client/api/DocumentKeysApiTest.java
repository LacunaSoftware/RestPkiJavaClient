...
/**
 * API tests for DocumentKeysApi
 */
@Ignore
public class DocumentKeysApiTest {

    private final DocumentKeysApi api = new DocumentKeysApi();
     ...
     */
    @Test
    public void apiDocumentKeysBatchPostTest()  {
        AllocateDocumentKeyBatchRequest allocateDocumentKeyBatchRequest = null;
        List<DocumentKeyModel> response = api.apiDocumentKeysBatchPost(allocateDocumentKeyBatchRequest);
     ...
     */
    @Test
    public void apiDocumentKeysKeyGetTest()  {
        String key = null;
        DocumentKeyQueryResponse response = api.apiDocumentKeysKeyGet(key);
     ...
     */
    @Test
    public void apiDocumentKeysPostTest()  {
        AllocateDocumentKeyRequest allocateDocumentKeyRequest = null;
        DocumentKeyModel response = api.apiDocumentKeysPost(allocateDocumentKeyRequest);
     ...
     */
    @Test
    public void apiDocumentKeysUnusedGetTest()  {
        String metadataName = null;
        String metadataValue = null;
        List<DocumentKeySummary> response = api.apiDocumentKeysUnusedGet(metadataName, metadataValue);
