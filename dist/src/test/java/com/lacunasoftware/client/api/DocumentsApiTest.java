...
public class DocumentsApiTest {
    ...
    public void apiDocumentsIdGetTest()  {
        UUID id = null;
        DocumentModel response = api.apiDocumentsIdGet(id);
     ...
     */
    @Test
    public void apiDocumentsIdSignersGetTest()  {
        UUID id = null;
        List<SignerModel> response = api.apiDocumentsIdSignersGet(id);
     ...
     */
    @Test
    public void apiDocumentsKeysKeyGetTest()  {
        String key = null;
        DocumentQueryResponse response = api.apiDocumentsKeysKeyGet(key);
