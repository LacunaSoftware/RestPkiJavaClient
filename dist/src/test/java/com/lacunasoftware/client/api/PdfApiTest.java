...
public class PdfApiTest {
     ...
     */
    @Test
    public void apiPdfAddMarksPostTest()  {
        PdfAddMarksRequest pdfAddMarksRequest = null;
        PdfAddMarksResponse response = api.apiPdfAddMarksPost(pdfAddMarksRequest);
     ...
     */
    @Test
    public void apiPdfStampPostTest()  {
        StampPdfRequest stampPdfRequest = null;
        StampPdfResponse response = api.apiPdfStampPost(stampPdfRequest);
